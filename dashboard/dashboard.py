...
from image_pipeline import nasa_pipeline, get_iss_location, get_image_of_the_day
...
page = st.sidebar.selectbox('Navigate', ['Home', 'Weather', 'Stellarium Integration',
                                         'Subscriber Signup', 'Test'])
